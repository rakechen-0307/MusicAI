...
class MusicTransferPipeline(DiffusionPipeline):
    ...
    def encode_prompt(
        self, prompt, device, do_classifier_free_guidance, negative_prompt=None, 
    ...
    def encode_duration(
        self, audio_start_in_s, audio_end_in_s,
        device, do_classifier_free_guidance, batch_size
    ):
    ...
    def check_inputs(
        self, prompt, audio_start_in_s, audio_end_in_s,
        callback_steps, negative_prompt=None,
    ...
    def prepare_latents(
        self, batch_size, num_channels_vae, sample_size,
